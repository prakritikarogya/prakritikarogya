                    ...
                    <div className="py-8 lg:py-16 lg:px-6 ">
                        <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                                <a href="#">
                                    <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://dm0qx8t0i9gc9.cloudfront.net/watermarks/image/rDtN98Qoishumwih/health-and-medical-background-with-doctor_MJt8cjdu_SB_PM.jpg" alt="Bonnie Avatar" />
                                </a>
                                <div className="p-5">
